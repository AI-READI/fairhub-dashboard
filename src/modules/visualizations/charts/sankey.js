    ...
    this.gradients = this.svg.append("defs")
        ...
        .enter()
          .append("linearGradient")
            ...
            .attr("id", d => `${this.uid}_gradient_${this.tokenize(d.source.name)}_${this.tokenize(d.target.name)}`)
    ...
    this.links = this.svg.append("g")
        ...
        .enter("path")
          .append("path")
            ...
            .attr("fill", "none")
            .attr("stroke", d => `url(#${this.uid}_gradient_${this.tokenize(d.source.name)}_${this.tokenize(d.target.name)})`)
    ...
    this.nodelabels = this.svg.append("g")
        ...
        .join("text")
          .text(d => `${d.name} (${d.value})`)
            ...
            .attr("id", d =>  `${this.uid}_node-label_${this.tokenize(d.name)}`)
